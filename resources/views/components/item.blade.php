...
{{--    </div>--}}
    ...
    @if($item->owner == $user->id)
        <div class="d-flex flex-column align-content-between align-self-center">
            <a class="btn btn-outline-secondary mt-1" title="Edit" href="/home/{{ $item->id }}/edit">
    ...
    @else
        <div class="d-flex flex-column align-content-between align-self-center">
            ...
            <a class="btn disabled btn-outline-primary mt-1" title="Share" href="/home/{{ $item->id }}/share">
                <i class="fas fa-share"></i>
            </a>
            <a class="btn disabled btn-outline-danger mt-1" title="Delete" href="/home/{{ $item->id }}/delete">
                <i class="fas fa-trash"></i>
            </a>
        </div>
    @endif
